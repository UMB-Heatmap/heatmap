# 3D HEATMAP VISUALIZATION WITHOUT INTERPOLATION:
...
#   python3 3d_no_ip.py (algorithm) (seed)
...
# 3D Visualization requires 2 additional inputs:
#   number_of_points, color_map
