...
numCandidates = getIntFromInput("Number of Candidates: ")
numIterations = getIntFromInput("Number of Iterations: ")
numValsPerIter = getIntFromInput("Number of Values per Iteration: ")
isNormalized = getBoolFromInput("Normalize Distributions? (Y/N): ")
